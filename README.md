...
[![Version](https://img.shields.io/badge/version-v1.0.2-orange)](https://github.com/Rashay01/rashaydaya-portfolio/releases)
...
```yaml
- uses: Rashay01/rashaydaya-portfolio@v1.0.2
```
