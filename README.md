...
[![Version](https://img.shields.io/badge/version-v2.1.1-orange)](https://github.com/Rashay01/rashaydaya-portfolio/releases)
...
```yaml
- uses: Rashay01/rashaydaya-portfolio@v2.1.1
```
